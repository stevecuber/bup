...
ActiveRecord::Schema.define(:version => 20140212062035) do

  create_table "refinery_careers", :force => true do |t|
    t.string   "name"
    t.string   "position"
    t.text     "message"
    t.integer  "cv_id"
  ...
  add_index "refinery_careers", ["id"], :name => "index_refinery_careers_on_id"
